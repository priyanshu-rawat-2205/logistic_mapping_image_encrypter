...
class LogisticMapping():
    ...
    def LogisticDecryption(self, imageName, key):
        N = 256
        ...
        x = x_prev
        y = y_prev
        imageMatrix,dimensionX, dimensionY, color = self.getImageMatrix(imageName)
    ...
    def LogisticEncryption(self, imageName, key):
        N = 256
        key_list = [ord(x) for x in key]
        G = [key_list[0:4] ,key_list[4:8], key_list[8:12]]
        g = []
